...
rule extract_genotypes:
    input:
        ...
        samples = "../../data/Waszak_2015/Waszak_2015_genotype_list.txt"
    output:
        vcf = "/gpfs/hpchome/a72094/rocket/projects/chromatin-QTLs/Blood_ATAC/results/PU1/genotypes/Waszak_47_samples.chr{chromosome}.vcf.gz"
    threads: 1
    resources:
        mem = 3000
    shell:
